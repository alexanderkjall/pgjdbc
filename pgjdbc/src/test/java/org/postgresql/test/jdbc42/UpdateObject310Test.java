...
public class UpdateObject310Test {
    ...
    public void insert() throws SQLException {
        ...
        try {
            s.executeUpdate("insert into UpdateObject310Test(timestamp_without_time_zone_column) values('2003-01-01'::timestamp)");
            rs = s.executeQuery(TestUtil.selectSQL("UpdateObject310Test", "table_id, timestamp_without_time_zone_column"));
            rs.next();
